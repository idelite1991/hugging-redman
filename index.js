...
const UUID = process.env.UUID || '4c474221-5a20-4ec8-b4f8-fcb52a3efcad'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'redman';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'Hug-redman';                    // 节点名称
